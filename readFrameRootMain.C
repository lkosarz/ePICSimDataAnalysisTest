...
int readFrameRootMain(TString list = "data/filesSim_hcal_only_test.list", TString ofname = "output/output_test.root", long nevents = -1);
...
int readFrameRootMain(TString list, TString ofname, long nevents)
{
